...
class ConditionsDict(DADict):
  ...
  def active_conditions(self, language="en"):
    return DAList(elements=[condition for condition in self.as_list(language=language) if not (hasattr(condition, "condition_ended") and condition.condition_ended)])

  def resolved_conditions(self, language="en"):
    return DAList(elements=[condition for condition in self.as_list(language=language) if (hasattr(condition, "condition_ended") and condition.condition_ended)])

...
setup(name='docassemble.HousingCodeChecklist',
      ...
      install_requires=['docassemble.ALMassachusetts>=0.1.2', 'docassemble.AssemblyLine>=2.22.1', 'docassemble.MAHousingTRO', 'docassemble.MassAccess>=0.3.0', 'docassemble.RentalRepairLetter', 'docassemble.SanitaryCode'],
      zip_safe=False,

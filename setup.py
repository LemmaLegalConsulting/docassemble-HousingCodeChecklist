...
setup(name='docassemble.HousingCodeChecklist',
      ...
      install_requires=['docassemble.ALMassachusetts>=0.1.1', 'docassemble.AssemblyLine>=2.13.0', 'docassemble.MAHousingTRO', 'docassemble.MassAccess>=0.3.0', 'docassemble.RentalRepairLetter', 'docassemble.SanitaryCode'],
      zip_safe=False,

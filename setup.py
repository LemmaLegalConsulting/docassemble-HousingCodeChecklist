...
setup(name='docassemble.HousingCodeChecklist',
      ...
      install_requires=['docassemble.ALMassachusetts>=0.1.0', 'docassemble.AssemblyLine>=2.10.2', 'docassemble.MAHousingTRO', 'docassemble.MassAccess>=0.2.0', 'docassemble.RentalRepairLetter', 'docassemble.SanitaryCode'],
      zip_safe=False,
